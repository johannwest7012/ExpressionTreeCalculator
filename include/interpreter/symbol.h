...
class UnaryOperatorLeft : public Symbol {
public:
    // constructor
    explicit UnaryOperatorLeft(Symbol* left, int precedence = 1);
    // destructor
    ~UnaryOperatorLeft() override = default;
};
...
class Factorial : public UnaryOperatorLeft {
public:
    // constructor
    Factorial();
    // destructor
...
/**
 * @class Exponent
 * @brief Exponent node of the parse tree
 */
...
/**
 * @class Ceiling
 * @brief Ceiling node of the parse tree
 */
...
/**
 * @class Floor
 * @brief Floor node of the parse tree
 */
